...
const HistorySection = () => {
  ...
  return (
    <section className="mt-8">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Previous History</h2>
      ...
      {historyItems.length === 0 && (
        <div className="text-center py-12 bg-gray-50 rounded-xl border border-gray-200">
          ...
          <p className="text-gray-500">No history yet. Start using AI tools to build your history!</p>
        </div>
      )}
    </section>
  );
